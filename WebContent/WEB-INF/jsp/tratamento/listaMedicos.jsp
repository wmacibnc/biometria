<!-- Modal -->
<div id="novoTratamento" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<!-- Modal content-->
		<div class="modal-content">
			<div class="modal-body">
				<div class="panel panel-default">
					<div class="panel-heading">Novo Tratamento</div>
					<div class="panel-body">
						<form id="escolherMedicoForm" action="<c:url value="/escolherMedico"/>"
							method="POST">
