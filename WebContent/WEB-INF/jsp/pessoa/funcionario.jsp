<div class="container">
    ...
    <div class="panel panel-default">
            ...
            <span class="title-pager">Lista de Funcionários</span>
...
<a href="<c:url value="/telaInicial"/>">
	...
	<button type="button" class="btn btn-success btn-footer" data-toggle="modal" data-target="#novo">Novo Funcionário</button>
</div>
